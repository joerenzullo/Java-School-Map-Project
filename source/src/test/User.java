...
public class User
{
    ...
    */
    ...
    Vertex[] vertices = { VHH, VL, VCC, VD, VIT, VB, VC, VG, VR, VZ,
        ...
        CC2, L3, D2, D3, C1, C2, C3, E2, E3, PLAZ, LL, UU1, C4, U1, 
        UU2, B1, B2, G, R4, IT1, R1, Z, R3, R5, C5, C6, V2, AMP, W1,
        LP1, V1, U2, IT2, LP2, CA1, IT3, W2, FS, FC, GM1, CA2, P1, 
        P, O, FB, GM2, P2, SV, STAD};
